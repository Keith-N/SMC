...
volatile unsigned long R1 = 1500, R2 = 1500, R3 = 0, R4 = 1500, R5 = 0, R6 = 1500; // Receiver Pulses {Pitch, Roll, Heave, Yaw}
...
void gyro_signalen(){
  ...
  accX = accel_event.acceleration.x - 0.368341947 ;
  accY = accel_event.acceleration.y + 0.083269046;
  accZ = accel_event.acceleration.z - 0.171054196;
  ...
  //Angles [rad]//
  yaw = -asin(sin(filter.getYaw()*deg2rad)) + 0.750492;
}
