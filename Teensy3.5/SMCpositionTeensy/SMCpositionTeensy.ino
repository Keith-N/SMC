...
//Magnetometer//
float mag_offsets[3] = { 18.73F, -34.80F, 43.01F };
float mag_softiron_matrix[3][3] = {{ 0.971, -0.027,  0.017 },
                                    { -0.027,  0.983, -0.037 },
                                    { 0.017, -0.037,  1.050 }};
float mag_field_strength = 37.06F;
float yawCal = -0.7243116;
...
//Receiver//
volatile unsigned long R1, R2, R3, R4, R5, R6;          // [us] Receiver Pulses {Pitch, Roll, Heave, Yaw}
...
void gyro_signalen(){
  ...
  rollD1 = gyro_event.gyro.x - rollD1cal;
  pitchD1 = gyro_event.gyro.y - pitchD1cal;
  yawD1 = -gyro_event.gyro.z - yawD1cal;
...
void smc() {
  ...
  //Thrust Inputs//                               
  u1 = (throttle-1000.0)*30.0/1000.0 + uz; // [N] Heave
