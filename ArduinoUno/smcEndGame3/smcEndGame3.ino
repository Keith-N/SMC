///////////////////////////////////////////////////////////////////////////////////////
//Sliding Mode Quadcopter Flight Controller V4 (vultureSMC.ino)
///////////////////////////////////////////////////////////////////////////////////////
...
long accA, accX, accY, accZ, GyX, GyY, GyZ;
...
//Accelerometer//
float accRoll, accPitch, accPitchCal, accRollCal;        //Euler Angles
...
float pitchCal, rollCal, yawCal, pitchDcal, rollDcal, yawDcal;
...
void setup(){
  ...
  for (calcInt = 0; calcInt < 2000 ; calcInt ++){                         
    gyro_signalen();                                                    
    calibration[0] += pitchD;
    calibration[1] += rollD; 
    calibration[2] += yawD;
    calibration[3] += accPitch; 
    calibration[4] += accRoll;                                            
  }
  pitchDcal = calibration[0]/2000.0;
  rollDcal = calibration[1]/2000.0;
  yawDcal = calibration[2]/2000.0;
  accPitchCal = calibration[3]/2000.0;
  accRollCal = calibration[4]/2000.0;
...
void loop(){
  ...
  u2 = ((kPitch*sPitch) + (cPitch*epitchD) + pitchDesD2 - (a1*rollD*yawD))/b1; // [Nm] Pitch Torque
  u3 = ((kRoll*sRoll) + (cRoll*erollD) + rollDesD2 - (a3*pitchD*yawD))/b2; // [Nm] Roll Torque
...
/** Debug Section
  ...
  Serial.println(pitchD/deg2rad);
  Serial.println("YAWD");
  Serial.println(yawD/deg2rad);

  //Serial.println("accPITCH");
  //Serial.println(accPitch/deg2rad);
...
void gyro_signalen(){
  ...
  //Gyro Rates [rad/s]//
  rollD =GyX/gyroSense - rollDcal;
  pitchD = GyY/gyroSense - pitchDcal;
  yawD = GyZ/gyroSense - yawDcal;
